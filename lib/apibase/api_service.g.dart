...
class _ApiService implements ApiService {
  ...
  Future<DaysForecast> getDaysForecast({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<DaysForecast>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = DaysForecast.fromJson(_result.data!);
    return value;
  }
  ...
  Future<Locations> getCityNames({
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<Locations>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = Locations.fromJson(_result.data!);
    return value;
  }
